...
### Changed
- feat(daily-log): Log section from list to table format (Time | Tags | Description). Tags without `#` (sales, marketing, job, ops). `core/templates/daily-log.md` and AGENTS.md Daily-log Execution Trace updated. Legacy list format deprecated.
