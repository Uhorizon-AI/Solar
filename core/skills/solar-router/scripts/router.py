...
DELIVERY_INSTRUCTION = (
    ...
    "them. No labels, no template, no headings; bullets only when they "
    "genuinely make it easier to read. Being clear matters more than being "
    "short, so take the room the work needs and no more. Name the artifact you "
    "acted on, "
